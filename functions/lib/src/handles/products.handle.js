...
import { obtainDataFromXlsx, getProductsFromDB, } from "../utils/getDataFromXls.js";
// const tmpPath = os.tmpdir();
export const createProductsAndCodRedToDBHandle = (req, res) => {
...
export const updateProductsAndCodRedToDBHandle = (req, res) => {
...
export const getAllProductsHandle = (req, res) => {
    getProductsFromDB()
        .then(data => {
